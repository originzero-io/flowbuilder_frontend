...
const customNodes = {
  ...
  [types.EXCEL_WRITE]: NotificationNode,
  ...
  [types.TCP_IN]: SetVariablesNode,
  [types.TCP_OUT]: NotificationNode,
  [types.MODBUS_READ]: SetVariablesNode,
  [types.MODBUS_WRITE]: NotificationNode,
  [types.S7_READ]: SetVariablesNode,
  [types.S7_WRITE]: NotificationNode,
  [types.SEND_SMS]: NotificationNode,
  [types.SEND_MAIL]: NotificationNode,
